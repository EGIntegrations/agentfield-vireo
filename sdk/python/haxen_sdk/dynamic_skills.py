...
class DynamicMCPSkillManager:
    """
    Dynamic MCP Skill Generator that converts MCP tools into Haxen skills.

    This class discovers MCP servers, lists their tools, and dynamically
    registers each tool as a Haxen skill with proper schema generation
    ...
    def __init__(self, agent, dev_mode: bool = False):
        ...
        Args:
            agent: The Haxen agent instance
    ...
    async def discover_and_register_all_skills(self) -> None:
        """
        Discover and register all MCP tools as Haxen skills.
        ...
        6. Registers each tool as a Haxen skill
        """
    ...
    async def _register_mcp_tool_as_skill(
        ...
        """
        Register an MCP tool as a Haxen skill.
