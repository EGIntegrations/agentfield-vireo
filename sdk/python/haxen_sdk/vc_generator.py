...
class VCGenerator:
    ...
    - VC verification
    - Integration with Haxen Server
    """

    def __init__(self, haxen_server_url: str):
        """
    ...
    def generate_execution_vc(
        ...
        try:
            ...
            # Send VC generation request to Haxen Server
            response = requests.post(
                f"{self.haxen_server_url}/api/v1/execution/vc", json=vc_data, timeout=10
            )
    ...
    def verify_vc(self, vc_document: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            response = requests.post(
                f"{self.haxen_server_url}/api/v1/did/verify",
    ...
    def get_workflow_vc_chain(self, workflow_id: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            response = requests.get(
                f"{self.haxen_server_url}/api/v1/did/workflow/{workflow_id}/vc-chain",
                timeout=10,
            )
    ...
    def create_workflow_vc(
        ...
        try:
            ...
            response = requests.post(
                f"{self.haxen_server_url}/api/v1/did/workflow/{workflow_id}/vc",
                json=workflow_data,
                timeout=10,
            )
    ...
    def export_vcs(
        ...
        try:
            ...
            response = requests.get(
                f"{self.haxen_server_url}/api/v1/did/export/vcs",
                params=params,
                timeout=30,
            )
