...
from haxen_sdk.types import AgentStatus, MCPServerHealth
...
class AgentMCP:
    ...
    def _create_and_register_mcp_skill(
        ...
        """
        Create and register a single MCP tool as a Haxen skill.
    ...
    async def _background_mcp_initialization(self) -> None:
        ...
        try:
            ...
            await self.agent.haxen_handler.send_enhanced_heartbeat()
