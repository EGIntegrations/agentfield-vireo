"""
Async execution configuration for the Haxen SDK.
...
class AsyncConfig:
    ...
    def from_environment(cls) -> "AsyncConfig":
        ...
        Environment variables use the prefix HAXEN_ASYNC_ followed by the
        uppercase parameter name. For example:
        - HAXEN_ASYNC_MAX_EXECUTION_TIMEOUT=1800
        - HAXEN_ASYNC_BATCH_SIZE=50
        ...
        def get_env_var(name: str, default_value, converter=None):
            env_name = f"HAXEN_ASYNC_{name.upper()}"
