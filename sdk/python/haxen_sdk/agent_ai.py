...
from haxen_sdk.logger import log_debug, log_error, log_warn
from haxen_sdk.rate_limiter import StatelessRateLimiter
...
class AgentAI:
    """AI/LLM Integration functionality for Haxen Agent"""
    ...
    def _process_multimodal_args(self, args: tuple) -> List[Dict[str, Any]]:
        ...
        from haxen_sdk.multimodal import Audio, File, Image, Text
    ...
    async def _generate_tts_audio(
        ...
        **kwargs,
        ...
        """
        import litellm
        from haxen_sdk.multimodal_response import (
            AudioOutput,
            MultimodalResponse,
        )
    ...
    async def _generate_openai_direct_audio(
        ...
        **kwargs,
        ...
        from haxen_sdk.multimodal_response import AudioOutput, MultimodalResponse
    ...
    async def ai_with_vision(
        ...
        **kwargs,
        ...
        try:
            ...
            # Import multimodal response detection
            from haxen_sdk.multimodal_response import detect_multimodal_response
