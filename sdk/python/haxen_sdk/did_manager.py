...
class DIDManager:
    """
    Manages DID operations for Haxen SDK agents.
    ...
    def __init__(self, haxen_server_url: str, agent_node_id: str):
        """
        Initialize DID Manager.

        Args:
            haxen_server_url: URL of the Haxen Server
            agent_node_id: Unique identifier for this agent node
        """
        self.haxen_server_url = haxen_server_url.rstrip("/")
    ...
    def register_agent(
        ...
        """
        Register agent with Haxen Server and obtain DID identity package.
        ...
        try:
            ...
            # Send registration request to Haxen Server
            response = requests.post(
                f"{self.haxen_server_url}/api/v1/did/register",
    ...
    def resolve_did(self, did: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            response = requests.get(
                f"{self.haxen_server_url}/api/v1/did/resolve/{did}", timeout=10
            )
    ...
    def get_identity_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "haxen_server_id": self.identity_package.haxen_server_id,
    ...
    def _parse_identity_package(
        ...
        return DIDIdentityPackage(
            ...
            haxen_server_id=package_data["haxen_server_id"],
        )
